...
describe("Qiscus API Client", function() {
	it ("should be able to generate proper Qiscus' list rooms API", function() {
		...
		var expected = "http://staging.qisc.us/api/v1/mobile/rooms?token=abcdef";
