...
qiscusListener.Pusher = (function() {
	...
	QiscusListenerPusher.prototype.listenRoomEvent = function(roomChannelCode, roomId) {
		...
		channel.bind('delete', function(data) {
			qiscusListener.handleCommentDeleted(data, _this.user);
			_this.onAfterEvent();
		});
		...
		channel.bind('newPeople', function(data) {
			qiscusListener.handleParticipantJoined(data, _this.user, roomId);
			_this.onAfterEvent();
		});
	};
