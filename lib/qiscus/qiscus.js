...
var qiscus = (function(_) {
	...
	Room.prototype.getParticipant = function(participantUsername) {
		var existingParticipant = _.find(this.participants, { 'username': participantUsername });
	...
	Room.prototype.addParticipant = function(participant) {
		var existingParticipant = this.getParticipant(participant.username)
		if (existingParticipant) {
			return;
		}
